  ...
  const handleGenerateCalendar = async () => {
    try {
      ...
      if (response.ok) {
        ...
        alert('Error generant el calendari');
      }
    } catch (err) {
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <Card className="mb-6">
              ...
              {previewMatches.length === 0 ? (
                <p className="text-center text-[#5F5E5A] py-8">
                  No s'ha pogut generar el calendari amb els paràmetres configurats
                </p>
              ) : (
            ...
            <div className="flex gap-4 justify-end">
              ...
              <Button variant="primary" disabled={previewMatches.length === 0}>
                Publicar calendari
              </Button>
            </div>
          </div>
          ...
          <Card>
            ...
            <div className="flex justify-between mt-8 pt-6 border-t border-[#D3D1C7]">
              ...
              {currentStep < 4 ? (
                ...
                >
                  {isLoadingCalendar ? 'Generant...' : 'Generar calendari'}
                </Button>
              )}
            </div>
          </Card>
